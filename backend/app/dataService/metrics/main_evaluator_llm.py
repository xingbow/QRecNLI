...
def evaluate_user_session(json_filepath: str, schema_folder_name: str, schema_base_dir: str) -> dict:
    ...
    """
    all_metrics = {}
    db_filename = f"{schema_folder_name}.sqlite"
    db_filepath = os.path.join(schema_base_dir, schema_folder_name, db_filename)
    ...
    print(f"\n--- Starting evaluation: '{json_filepath}' | Database: '{db_filepath}' ---")

    # Calculate coverage metrics
    coverage_evaluator = CoverageEvaluator(json_filepath, db_filepath)
