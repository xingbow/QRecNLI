...
# Spider dataset
if not os.path.isfile(os.path.join(prefix, 'dataset/spider.zip')):
    ...
    gdown.download("https://drive.google.com/uc?export=download&id=1_AckYkinAnhqmRQtGsQgUKAnTHxxX5J0", output, quiet=False)
